...
%>
  ...
  <%--  <c:forEach items="${listProductInventory}" var="a"> --%>
     <div id="div_1" class="used">
                                  ...
                                  材料名称：<input  type="text" class="mini-input" name="cailiaoMc"  readonly value="${item.cailiaoMc}"/>  
                                   材料编号：<input type="text"  class="mini-input" style="width:120px" readonly name="cailiaoBh"  value="${item.cailiaoBh}"/> 
