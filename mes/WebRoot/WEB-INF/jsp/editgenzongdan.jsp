		...
		<form id="form" class="form-inline" method="post" action="${pageContext.request.contextPath}/record/editTrackCard.action">
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td><label for="materialBatchNo">材料批次号:</label>
					</td>
					<td><input type="text" style="width:150px" id="cailiaopicihao"
						class="form-control" name="materialBatchNo"
						value="${trackCard.materialBatchNo}" />&nbsp;&nbsp;<span id="open" class="glyphicon glyphicon-pencil"></span>
					</td>
				...
				<div>
					<div class="add">
						<span>组件1</span><input type="text" id="del-text1"
							class="form-control" name="text1" value=""> <a
				...
				<div class="hidden"> 
					...
					<table class="table table-hover used">
						...
						<tr>
							...
							<c:if test="${(empty a.price)||(a.price==' ')}">
								<input type="text" class="form-control" name="price${stauts.index+1}" style="width:325px" readonly value="临时工价还未审批通过!/bom未录入该工价信息!"/>
							</c:if>
							</td>
						</tr>
