...
<head>
	...
	//excel导出
	 ...
	 $.ajax({
					url : "${pageContext.request.contextPath}/record/outportFullProductExcel.action",
					type : "POST",
					...
					if(data==1){
					layer.alert("产成品入库单excel导出成功!请在桌面查收文件！", {
		               ...
		               layer.closeAll();
		            	...
		            	layer.alert("您的产成品入库excel模板选择错误!", {
		                skin: 'layui-layer-molv', //样式类名
		                closeBtn: 0
		            }, function(){
		               layer.closeAll();
	...
	<div class="container">
		...
		<form class="form-inline" id="forms"  method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/record/toOutputFullMaterialsRecord.action" >
		  	...
		  	<div class="form-group">
		  		<label for="">物料号</label>
		   		<input type="text" class="form-control" name="material_no" style="width:120px;"value="" >
		  	</div>
		  	<div class="form-group">
