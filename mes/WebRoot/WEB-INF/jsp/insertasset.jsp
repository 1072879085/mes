...
<div class="container">
    <h4>设备详细信息</h4>
        <form id="form" class="form-inline" action="${pageContext.request.contextPath}/manage/insertAsset.action">
            <table class="table table-hover">
              	<tr>
                	...
                	<td><input type="text" class="form-control" style="width:300px" name="assetNo" value=""/></td>
