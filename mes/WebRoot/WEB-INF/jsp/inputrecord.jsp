...
//excel导出
	 ...
	 $.ajax({
					url : "${pageContext.request.contextPath}/record/importRawMaterialExcel.action",
					type : "POST",
					...
					if(data==1){
					layer.alert("原材料出库单excel导出成功!请在桌面查收文件！", {
	...
	<div class="container">
		...
		<form id="forms" class="form-inline"  method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/record/InputMaterialsRecord.action">
		  	...
		  	<div class="form-group">
		  		<label for="">物料号</label>
		   		<input type="text" class="form-control" name="material_no" id="wl" style="width:120px;" value="">
		  	</div>
		  	<div class="form-group">
