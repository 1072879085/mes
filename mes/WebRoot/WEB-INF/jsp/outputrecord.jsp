...
<head>
	...
	//excel导出
	 ...
	 $.ajax({
					url : "${pageContext.request.contextPath}/record/outportRawMaterialExcel.action",
					type : "POST",
					...
					if(data==1){
					layer.alert("退原材料单excel导出成功!请在桌面查收文件！", {
