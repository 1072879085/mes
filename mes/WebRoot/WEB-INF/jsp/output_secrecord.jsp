...
<head>
	...
	//excel导出
	 ...
	 $.ajax({
					url : "${pageContext.request.contextPath}/record/outportSecMaterialExcel.action",
					type : "POST",
					...
					if(data==1){
					layer.alert("退辅料单excel导出成功!请在桌面查收文件！", {
		               ...
		               layer.closeAll();
		            	...
		            	layer.alert("退辅料单excel导出失败!是否桌面已经存在该文件名！", {
		                skin: 'layui-layer-molv', //样式类名
		                closeBtn: 0
		            }, function(){
		               layer.closeAll();
		...
		<form class="form-inline"  id="forms" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/record/toOutputSecMaterialsRecord.action">
		  	...
		  	<div class="form-group">
		  		<label for="">车间名称</label>
		   		<input type="text" class="form-control" style="width:120px;" name="reshopName" value="">
		  	</div>
		  	<div class="form-group">
