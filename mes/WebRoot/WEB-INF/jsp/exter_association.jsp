	...
	<div class="container">
		...
		<form class="form-inline top"  method="post" action="${pageContext.request.contextPath}/record/toExterAssociation.action">
		  	...
		  	<div class="form-group">
		  		<label for="">物料号</label>
		   		<input type="text" class="form-control" style="width: 100px" name="material_no" id="wl">
		  	</div>
		  	<div class="form-group">
		  		<label for="">起始日期</label>
		    	<div class="input-group date form_date"  data-date-format="yyyy-mm-dd">
            		<input class="form-control" size="10" type="text" name="start_date" id="st" value=""/>
		  	...
		  	<div class="form-group">
		    	...
		    	<div class="input-group date form_date"  data-date-format="yyyy-mm-dd">
            		<input class="form-control" size="10" type="text" name="end_date" id="et" value=""/>
            		 <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
            		<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
       			</div>
		  	</div>
		  ...
		  &nbsp;
		   <input class="btn btn-danger" type="button" value="部分外协excel" onclick="revise(this)">
		</form> 
		<br />
		<div class="container">	   
		<div class="table-responsive">
			...
			<!-- 循环输出forEach -->
					<tr>	
						<td>
						<c:if test="${a.shop2!='外协'}">${a.provider}</c:if>
						<c:if test="${a.shop2=='外协'}">${a.acceptor}</c:if>
						</td>				
						<td>${a.planNo}</td>
